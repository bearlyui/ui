...
<button
    {{ $attributes
        ...
        ->class([
            ...
            {{-- Base Variant Styles --}}
            'border shadow-sm' => Variant::Outline->is($variant) || Variant::Solid->is($variant),
            {{-- '[text-shadow:1px_0.5px_0px_rgba(0,0,0,0.24)]' => Variant::Solid->is($variant) || Variant::Gradient->is($variant), --}}

            {{-- Solid Variant --}}
            'bg-primary-400 text-primary-900 border-primary-600/60 hover:bg-primary-700 hover:text-white dark:text-primary-300 dark:hover:text-primary-200 dark:border-primary-500/30 dark:bg-primary-400/30 dark:hover:bg-primary-400/50' => Color::Primary->is($color) && Variant::Solid->is($variant),
            ...
            'bg-success-400 text-success-900 border-success-600/60 hover:bg-success-600 hover:text-white dark:text-success-500 dark:hover:text-success-200 dark:border-success-500/30 dark:bg-success-400/15 dark:hover:bg-success-400/40' => Color::Success->is($color) && Variant::Solid->is($variant),
