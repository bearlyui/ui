...
<{{ $href ? 'a' : 'button' }}
    {{ $attributes
        ...
        ->class([
            ...
            {{-- Solid Variant --}}
            'bg-primary-700 text-white border-primary-600/60 hover:bg-primary-900 dark:text-primary-100 dark:hover:text-primary-50 dark:border-primary-500/30 dark:bg-primary-400/30 dark:hover:bg-primary-400/50' => Color::Primary->is($color) && Variant::Solid->is($variant),
