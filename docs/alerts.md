...
You can control the vertical alignment of the icon using the `iconAlign` property. Available values are: `start` _(default)_, `center`, and `end`.

```html +demo title={Icon Alignment} previewClasses={space-y-4}
<ui:alert icon="information-circle" iconAlign="start">
...
<ui:alert icon="information-circle" iconAlign="center">
...
<ui:alert icon="information-circle" iconAlign="end">
