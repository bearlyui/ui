...
class InputGroupTest extends TestCase
{
    ...
    {
        $this->blade('<x-ui::input-group>Foo</x-ui::input-group>')
            ->assertSeeHtmlInOrder(['<div', '>', 'Foo', '</div>']);
    }

    public function test_other_attributes()
    {
        $this->blade('<x-ui::input-group thing="amajig">Foo</x-ui::input-group>')
            ->assertSeeHtmlInOrder(['<div', 'thing="amajig"', '>', 'Foo', '</div>']);
    }

    public function test_label_prop()
    {
        $this->blade('<x-ui::input-group label="Foo">Bar</x-ui::input-group>')
    ...
    public function test_for_prop_shows_errors()
    {
        $this->withViewErrors(['bar' => 'Baz'])
            ->blade('<x-ui::input-group for="bar">Foo</x-ui::input-group>')
    ...
    {
        $this->withViewErrors(['bar' => 'Baz'])
            ->blade('<x-ui::input-group for="bar" label="Foo">Bar</x-ui::input-group>')
